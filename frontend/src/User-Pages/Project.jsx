export default function Project() {
  return (
    <>
      <div className="w-full text-center lg:mt-7">
        <h1 className="text-3xl font-semibold lg:text-7xl text-[#fcffff]">Projects</h1>
      ...
      <div className="flex flex-col items-center w-full h-full lg:flex lg:flex-row lg:flex-wrap lg:min-h-screen lg:justify-around lg:w-300 lg:mt-7 lg:ml-40 ">
        ...
        <div className="w-82 h-120 mt-10 lg:w-110 lg:h-150 border-2 border-white lg:mt-10">
          <div>
            <div className="h-50 w-82 lg:h-60 lg:w-110 border border-red-500">
              <img src="" alt="" />
            </div>
          </div>
          <div className="ml-2 lg:ml-4">
            <h1 className="text-lg font-semibold mt-2 lg:text-2xl lg:mt-4 text-[#fcffff]">
              Title
            </h1>
            <p className="text-[#fcffff] text-[1rem] lg:text-lg lg:leading-8">
              Jan 24 - Feb 24
            </p>

            <p className="text-sm  leading-5 mt-2 lg:leading-7 lg:text-lg lg:mt-2 text-[#b1bac2]">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ea qui
              amet doloribus quaerat nostrum aliquid eos nobis repudiandae
              similique, fugit praesentiummodi maxime. Corrupti expedita, totam
              cum repellendus vero accusantium.
            </p>

            <div className="flex flex-wrap mt-2 gap-3 text-sm lg:text-lg text-[#b1bac2] lg:gap-3 lg:mt-4">
              <p className="bg-[#1e2e36] px-2.5 rounded-lg py-0.5 lg:px-3 lg:py-0.5 lg:rounded-2xl">
                HTML
              </p>
              <p className="bg-[#1e2e36] px-2.5 rounded-lg py-0.5 lg:px-3 lg:py-0.5 lg:rounded-2xl">
                CSS
            ...
            <div className="flex mt-4 gap-5 lg:gap-10 lg:mt-4 ">
              <div className="flex gap-1.5 h-10 w-25 bg-[#ff715b] rounded-lg text-[#121f28] lg:h-10 lg:w-28 ">
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="size-6 mt-1.5 lg:mt-1"
                >
                  <path
                ...
                <button className="lg:text-lg  ">Website</button>
              </div>
              <div className="flex border gap-1.5 h-10 w-25 border-[#ff715b] rounded-lg text-[#ff715b] lg:h-10 lg:w-28">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <button className="lg:text-lg ">Source</button>
              </div>
            </div>
          </div>
        </div>
